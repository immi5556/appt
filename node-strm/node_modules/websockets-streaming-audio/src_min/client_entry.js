...
ww_handle.onmessage = function(event) {  // handle traffic from ww
    ...
    // console.log("cool TOP onmessage");
...
var entry_point = (function() {     //      handle traffic from browser UI
    ...
    */
    ...
    msg_to_ww.mode_stream_audio_to_client = stream_audio_msg;
    msg_to_ww.mode = "mode_stream_audio";


    for (var curr_property in msg_to_ww) {

        if (msg_to_ww.hasOwnProperty(curr_property)) {

            console.log("msg_to_ww  PP " + curr_property + " " + msg_to_ww[curr_property]);
        }
    }
