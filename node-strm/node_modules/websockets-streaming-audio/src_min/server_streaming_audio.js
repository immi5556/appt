...
//         console.log("place holder for streaming audio");
//     };
...
var route_msg = function(received_json, curr_ws) {
    ...
    if (received_json.request_number === request_number) {
        ...
        if (typeof media_filename !== "undefined") {
            ...
            console.log("placeholder ... set_media_filename " + media_filename);
    ...
    switch (requested_action) {
        ...
        case "stream_audio_to_client" : {
            ...
            setTimeout(function() {
                ...
                send_client_source_data_info({

                    placeholder : "hello_Corinde"
