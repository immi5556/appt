  ...
  // ---
    ...
    web_socket.onmessage = function(event) {        //      receive message from server side
        ...
        if (typeof event.data === "string") {
            ...
            var float_array = new Float32Array(retrieved_length / Float32Array.BYTES_PER_ELEMENT);
            ...
            for (var index = 0, float_index = 0; index < retrieved_length; index += 4, float_index += 1) {
                ...
                float_array[float_index] = new Float32Array((new Uint8Array([
                ...
                // float_array[float_index] =  received_data[index + 0]       | 
                ...
                console.log(float_index + " output float ---> " + float_array[float_index]);
            }
            ...
            shared_utils.write_32_bit_float_buffer_to_16_bit_wav_file(float_array, output_filename);
